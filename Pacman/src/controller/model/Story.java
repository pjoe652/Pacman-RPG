...
public class Story {
	...
	/*
	 * This class contains all of the dialogues that are displayed in single player
	 */
	...
	public static final String[] FinalScript = new String[] {
			...
			"0They praised his heroism despite not knowing his purpose",
			"0The thugs faces' turned white upon seeing your return",
			"0With the money left over you decided to live the good life", "0 " };
}
