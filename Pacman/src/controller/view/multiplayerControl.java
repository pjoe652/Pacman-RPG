...
public class multiplayerControl {
	/*
	 * This class controls multiplayer.fxml
	 */
	...
	@FXML
	private ImageView playerOne = new ImageView();
	private int playerOneRotate = 0;
	@FXML
	private ImageView playerTwo = new ImageView();
	public static enemies characterTwo = new enemies();
	private int playerTwoRotate = 1;
	@FXML
	private ImageView playerThree = new ImageView();
	...
	@FXML
	public void handleNextButtonCharOne() {
	...
	@FXML
	public void handleMinusButtonCharOne() {
		if (playerOneRotate == 0) {
			characterOne.setModel("Black Knight");
			displayCharacter(characterOne, playerOne);
			playerOneRotate = 2;
	...
	@FXML
	public void handleNextButtonCharTwo() {
	...
	@FXML
	public void handleMinusButtonCharTwo() {
		if (playerTwoRotate == 0) {
			characterTwo.setModel("Blue");
			displayEnemy(characterTwo, playerTwo);
			playerTwoRotate = 4;
	...
	@FXML
	public void handleNextButtonCharThree() {
	...
	@FXML
	public void handleMinusButtonCharThree() {
		if (playerThreeRotate == 0) {
			characterThree.setModel("Blue");
			displayEnemy(characterThree, playerThree);
			playerThreeRotate = 4;
	...
	@FXML
	public void handleNextKeyPressed(KeyEvent event) {
